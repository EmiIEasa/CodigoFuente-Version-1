...
<div class="container-fluid" style="margin-top: 25px;">
    <button type="button" class="btn btn-success mb-2" runat="server" id="ExportarExcel" onserverclick="ExportarExcel_ServerClick"><i class="fa fa-file-excel-o"></i> Exportar Excel</button>
