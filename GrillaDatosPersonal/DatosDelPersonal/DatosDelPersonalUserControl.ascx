...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DatosDelPersonalUserControl.ascx.cs" Inherits="GrillaDatosPersonal.DatosDelPersonal.DatosDelPersonalUserControl" %>
