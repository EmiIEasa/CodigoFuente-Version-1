...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WP-TesoreriaUserControl.ascx.cs" Inherits="GrillaSegFact.WP_Tesoreria.WP_TesoreriaUserControl" %>
...
<div class="container-fluid" style="margin-top: 25px;">
	...
	<tbody>
        <asp:Literal ID="ltTablaContabilidad" runat="server"></asp:Literal>
	</tbody>
</table>
</div>